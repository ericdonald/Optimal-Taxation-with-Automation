...
class Processor:
    ...
    def StatusQuo_Optimum(self):
        ...
        Eqbm = sp.optimize.root(rt.Eqbm_Root, E_sq,
                      args=(θ, self.E.A_j, self.E.A_k, self.E.x_bar, self.E.ζ, self.E.ν, self.E.σ, self.E.J, self.E.n, self.E.y_0, self.E.Ψ, self.E.ψ, self.β, self.E.var_θ, self.E.ε, self.E.τ_k, self.E.δ, self.E.g, self.E.φ),
                      jac=pr.δH_δclx)
    ...
    def AI_Experiment(self, G_k, N_g):
        ...
        for g in range(N_g):
            ...
            Eqbm_θ_10 = sp.optimize.root(rt.Eqbm_Root, E_θ_10,
                          args=(θ_AI_10[g], A_j_AI_10, A_k_AI, self.E.x_bar, ζ_AI, ν_AI, self.E.σ, self.E.J, self.E.n, self.E.y_0, Ψ_AI_10, self.E.ψ, self.β, self.E.var_θ, self.E.ε, self.E.τ_k, self.E.δ, self.E.g, self.E.φ),
                          jac=pr.δH_δclx)
            E_θ_10 = Eqbm_θ_10.x
            ...
            Eqbm_θ_25 = sp.optimize.root(rt.Eqbm_Root, E_θ_25,
                          args=(θ_AI_25[g], A_j_AI_25, A_k_AI, self.E.x_bar, ζ_AI, ν_AI, self.E.σ, self.E.J, self.E.n, self.E.y_0, Ψ_AI_25, self.E.ψ, self.β, self.E.var_θ, self.E.ε, self.E.τ_k, self.E.δ, self.E.g, self.E.φ),
                          jac=pr.δH_δclx)
            E_θ_25 = Eqbm_θ_25.x
            ...
            Eqbm_θ_50 = sp.optimize.root(rt.Eqbm_Root, E_θ_50,
                          args=(θ_AI_50[g], A_j_AI_50, A_k_AI, self.E.x_bar, ζ_AI, ν_AI, self.E.σ, self.E.J, self.E.n, self.E.y_0, Ψ_AI_50, self.E.ψ, self.β, self.E.var_θ, self.E.ε, self.E.τ_k, self.E.δ, self.E.g, self.E.φ),
                          jac=pr.δH_δclx)
            E_θ_50 = Eqbm_θ_50.x
            ...
            Eqbm_LF_10 = sp.optimize.root(rt.Eqbm_Root, E_θ_10,
                          args=(0, A_j_AI_10, A_k_AI, self.E.x_bar, ζ_AI, ν_AI, self.E.σ, self.E.J, self.E.n, self.E.y_0, Ψ_AI_10, self.E.ψ, self.β, self.E.var_θ, self.E.ε, self.E.τ_k, self.E.δ, self.E.g, self.E.φ),
                          jac=pr.δH_δclx)
            ...
            Eqbm_LF_25 = sp.optimize.root(rt.Eqbm_Root, E_θ_25,
                          args=(0, A_j_AI_25, A_k_AI, self.E.x_bar, ζ_AI, ν_AI, self.E.σ, self.E.J, self.E.n, self.E.y_0, Ψ_AI_25, self.E.ψ, self.β, self.E.var_θ, self.E.ε, self.E.τ_k, self.E.δ, self.E.g, self.E.φ),
                          jac=pr.δH_δclx)
            ...
            Eqbm_LF_50 = sp.optimize.root(rt.Eqbm_Root, E_θ_50,
                          args=(0, A_j_AI_50, A_k_AI, self.E.x_bar, ζ_AI, ν_AI, self.E.σ, self.E.J, self.E.n, self.E.y_0, Ψ_AI_50, self.E.ψ, self.β, self.E.var_θ, self.E.ε, self.E.τ_k, self.E.δ, self.E.g, self.E.φ),
                          jac=pr.δH_δclx)
